...
using OrderingApplication.Features.Account.Addresses.Types;

namespace OrderingApplication.Features.Account.Addresses;
...
internal static class UserAddressEndpoints
{
    ...
    internal static void MapAccountAddressEndpoints( this IEndpointRouteBuilder app )
    {
        ...
        app.MapPut( "api/account/addresses/add", static async ( [FromBody] AddressDto request, HttpContext http, UserAddressManager system ) =>
